        ...
        <div className="bg-gray-100 min-h-screen p-8">
            ...
            <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-xl shadow p-4">
                    ...
                    <h2 className="font-semibold mb-4">Shop Summary</h2>
                    ...
                    <h3 className="font-semibold mb-3">
                        GreenEarth Bio Supplies
                    </h3>

                    <div className="text-sm text-gray-600 space-y-2">

                        <p>
                            <b>Location</b> Baner, Pune
                        </p>

                        <p>
                            <b>Shop ID</b> SHOP-5821
                        </p>

                        <p>
                            <b>Owner</b> Rahul Patil
                        </p>
                    ...
                    {showDetails && (
                        <div className="mt-4 bg-gray-50 rounded-lg p-4">
                            ...
                            <h3 className="font-semibold text-lg mb-2">Shop Description</h3>

                            <p className="text-sm text-gray-600 mb-4">
                                GreenEarth Bio Supplies provides organic fertilizers,
                                seeds and eco-friendly agricultural solutions for farmers.
                            </p>

                            <h3 className="font-semibold text-lg mb-2">Shop Information</h3>

                            <div className="text-sm text-gray-600 space-y-1">
                                <p>Contact: +91 8007810076</p>
                                <p>Email: contact@agrowmartindia.com</p>
                                <p>Address: Baner Street, Pune</p>
                ...
                <div className="md:col-span-2 bg-white rounded-xl shadow p-6">
                    ...
                    <p className="text-sm text-gray-500 mb-6">
                        Your feedback helps customers choose the best shops.
                    </p>
                                ...
                                <div className="flex justify-center gap-1 mt-1">
                                    ...
                                    {[1, 2, 3, 4, 5].map((star) => (
                                        ...
                                        <Star
                                            ...
                                            className={`w-4 h-4 cursor-pointer ${star <= sellerRatings[item.key]
                                                    ? "text-green-500 fill-green-500"
                                                    : "text-gray-300"
                                                }`}
                                        />
                    ...
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">
                                This helps others discover trusted shops.
                            </p>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <button
                                ...
                                className={`w-12 h-6 flex items-center rounded-full p-1 transition ${recommend ? "bg-green-600" : "bg-gray-300"
                                    }`}
                            >

                                <div
                                    className={`bg-white w-4 h-4 rounded-full shadow-md transform transition ${recommend ? "translate-x-6" : ""
                                        }`}
                                />
                            ...
                            <span
                                className={`font-medium ${recommend ? "text-green-600" : "text-gray-500"
                                    }`}
                            >
