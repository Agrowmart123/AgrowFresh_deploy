...
import { placeOrderFromCart } from "../services/api";
...
const cancelOrder = async (reason) => {
  try {
    await cancelOrderApi(orderId, { reason }); // ✅ correct
