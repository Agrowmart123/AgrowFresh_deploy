  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="bg-white rounded p-6 max-w-md w-full">
        <h3 className="text-lg font-semibold">Cart contains items from another shop</h3>
        ...
        <div className="mt-4 flex gap-3 justify-end">
          ...
          <button onClick={confirmClearAndAdd} className="px-3 py-1 bg-red-600 text-white rounded">Clear & Continue</button>
        </div>
      </div>
    </div>
  )
