...
export const getVendorBanners = () =>
  api.get("/vendor/content/banners");

//farmer
export const getAllApprovedFarmers = async () => {
  return api.get("/auth/farmer/all-approved");
};
...
export const updateAddress = (id, data) =>
  api.put(`${"/customer/addresses"}/${id}`, data).then((res) => res.data);
...
export const setDefaultAddress = (id) =>
  api.post(`${"/customer/addresses"}/${id}/default`).then((res) => res.data);

export const getRecentlyViewedProducts = () =>
  api.get("/public/recently-added").then((res) => res.data);
...
export const removeFromWishlist = (params) =>  api.delete("/customer/wishlist/remove", { params });
export const checkWishlist      = (params)  => api.get("/customer/wishlist");
...
export const getCustomerShopProducts = (shopId) =>
  api.get(`/public/shop/${shopId}/products`);
...
// WOMEN PRODUCTS
export const getWomenProductById = (id) =>
  api.get(`/women-products/${id}`);

// AGRI PRODUCTS
export const getAgriProductById = (id) =>
  api.get(`/v1/agri/products/${id}`);

export const getShopProductsById = (shopId) => {
  return api.get(`/products/shop/${shopId}`);
};
export const getWomenProductsByShop = (shopId) =>
  api.get(`/women-products/shop/${shopId}`);
export const getAgriProductsByShop = (shopId) =>
  api.get(`/v1/agri/products/shop/${shopId}`);
